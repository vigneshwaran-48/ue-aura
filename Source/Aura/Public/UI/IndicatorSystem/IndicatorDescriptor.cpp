...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UAuraIndicatorManagerComponent* InManager)
{
...
{
	if (UAuraIndicatorManagerComponent* Manager = ManagerPtr.Get())
	{
