 ...
 * Main Menu widget.
 *
 * This also explicitly pushes a blank widget onto the lower layers (Game and
 * GameMenu) so that any open UI elements cannot be interacted with at all while
 * the main menu is open.
 */
UCLASS()
class AURA_API UAuraMainMenuWidget : public UAuraActivatableWidget {
  GENERATED_BODY()
 ...
 protected:
  ...
  /** Blank widget to "occlude" lower layer widgets while the main menu is
   * active */
  UPROPERTY(EditDefaultsOnly)
  TSubclassOf<UAuraActivatableWidget> BlankWidgetClass;
